...
#[allow(unsafe_code)]
pub const SQLITE_VERSION: &::std::ffi::CStr =
    unsafe { ::std::ffi::CStr::from_bytes_with_nul_unchecked(b"3.49.2\0") };
pub const SQLITE_VERSION_NUMBER: i32 = 3049002;
#[allow(unsafe_code)]
pub const SQLITE_SOURCE_ID: &::std::ffi::CStr = unsafe {
    ::std::ffi::CStr::from_bytes_with_nul_unchecked(
        b"2025-05-07 10:39:52 17144570b0d96ae63cd6f3edca39e27ebd74925252bbaf6723bcb2f6b4861fb1\0",
    )
};
...
pub unsafe fn sqlite3_enable_shared_cache(
    ...
    assert!(! ptr.is_null(), "SQLite API not initialized or SQLite feature omitted");
    let fun: extern "C" fn(arg1: ::std::os::raw::c_int) -> ::std::os::raw::c_int = ::std::mem::transmute(
        ptr,
    );
    (fun)(arg1)
}
...
pub unsafe fn sqlite3_libversion_number() -> ::std::os::raw::c_int {
    ...
    assert!(! ptr.is_null(), "SQLite API not initialized or SQLite feature omitted");
    let fun: extern "C" fn() -> ::std::os::raw::c_int = ::std::mem::transmute(ptr);
    (fun)()
}
...
pub unsafe fn sqlite3_malloc(
    ...
    assert!(! ptr.is_null(), "SQLite API not initialized or SQLite feature omitted");
    let fun: extern "C" fn(arg1: ::std::os::raw::c_int) -> *mut ::std::os::raw::c_void = ::std::mem::transmute(
        ptr,
    );
    (fun)(arg1)
}
...
pub unsafe fn sqlite3_result_int(
    ...
    assert!(! ptr.is_null(), "SQLite API not initialized or SQLite feature omitted");
    let fun: extern "C" fn(arg1: *mut sqlite3_context, arg2: ::std::os::raw::c_int) = ::std::mem::transmute(
        ptr,
    );
    (fun)(arg1, arg2)
}
...
pub unsafe fn sqlite3_result_null(arg1: *mut sqlite3_context) {
    ...
    assert!(! ptr.is_null(), "SQLite API not initialized or SQLite feature omitted");
    let fun: extern "C" fn(arg1: *mut sqlite3_context) = ::std::mem::transmute(ptr);
    (fun)(arg1)
}
...
pub unsafe fn sqlite3_result_value(
    ...
    assert!(! ptr.is_null(), "SQLite API not initialized or SQLite feature omitted");
    let fun: extern "C" fn(arg1: *mut sqlite3_context, arg2: *mut sqlite3_value) = ::std::mem::transmute(
        ptr,
    );
    (fun)(arg1, arg2)
}
...
pub unsafe fn sqlite3_user_data(
    ...
    assert!(! ptr.is_null(), "SQLite API not initialized or SQLite feature omitted");
    let fun: extern "C" fn(arg1: *mut sqlite3_context) -> *mut ::std::os::raw::c_void = ::std::mem::transmute(
        ptr,
    );
    (fun)(arg1)
}
...
pub unsafe fn sqlite3_value_blob(
    ...
    assert!(! ptr.is_null(), "SQLite API not initialized or SQLite feature omitted");
    let fun: extern "C" fn(arg1: *mut sqlite3_value) -> *const ::std::os::raw::c_void = ::std::mem::transmute(
        ptr,
    );
    (fun)(arg1)
}
...
pub unsafe fn sqlite3_value_double(arg1: *mut sqlite3_value) -> f64 {
    ...
    assert!(! ptr.is_null(), "SQLite API not initialized or SQLite feature omitted");
    let fun: extern "C" fn(arg1: *mut sqlite3_value) -> f64 = ::std::mem::transmute(ptr);
    (fun)(arg1)
}
...
pub unsafe fn sqlite3_value_text(
    ...
    assert!(! ptr.is_null(), "SQLite API not initialized or SQLite feature omitted");
    let fun: extern "C" fn(arg1: *mut sqlite3_value) -> *const ::std::os::raw::c_uchar = ::std::mem::transmute(
        ptr,
    );
    (fun)(arg1)
}
...
pub unsafe fn sqlite3_soft_heap_limit(arg1: ::std::os::raw::c_int) {
    ...
    assert!(! ptr.is_null(), "SQLite API not initialized or SQLite feature omitted");
    let fun: extern "C" fn(arg1: ::std::os::raw::c_int) = ::std::mem::transmute(ptr);
    (fun)(arg1)
}
...
pub unsafe fn sqlite3_vfs_find(arg1: *const ::std::os::raw::c_char) -> *mut sqlite3_vfs {
    ...
    assert!(! ptr.is_null(), "SQLite API not initialized or SQLite feature omitted");
    let fun: extern "C" fn(arg1: *const ::std::os::raw::c_char) -> *mut sqlite3_vfs = ::std::mem::transmute(
        ptr,
    );
    (fun)(arg1)
}
...
pub unsafe fn sqlite3_sql(arg1: *mut sqlite3_stmt) -> *const ::std::os::raw::c_char {
    ...
    assert!(! ptr.is_null(), "SQLite API not initialized or SQLite feature omitted");
    let fun: extern "C" fn(arg1: *mut sqlite3_stmt) -> *const ::std::os::raw::c_char = ::std::mem::transmute(
        ptr,
    );
    (fun)(arg1)
}
...
pub unsafe fn sqlite3_result_subtype(
    ...
    assert!(! ptr.is_null(), "SQLite API not initialized or SQLite feature omitted");
    let fun: extern "C" fn(arg1: *mut sqlite3_context, arg2: ::std::os::raw::c_uint) = ::std::mem::transmute(
        ptr,
    );
    (fun)(arg1, arg2)
}
...
pub unsafe fn sqlite3_expanded_sql(
    ...
    assert!(! ptr.is_null(), "SQLite API not initialized or SQLite feature omitted");
    let fun: extern "C" fn(arg1: *mut sqlite3_stmt) -> *mut ::std::os::raw::c_char = ::std::mem::transmute(
        ptr,
    );
    (fun)(arg1)
}
...
pub unsafe fn sqlite3_str_finish(arg1: *mut sqlite3_str) -> *mut ::std::os::raw::c_char {
    ...
    assert!(! ptr.is_null(), "SQLite API not initialized or SQLite feature omitted");
    let fun: extern "C" fn(arg1: *mut sqlite3_str) -> *mut ::std::os::raw::c_char = ::std::mem::transmute(
        ptr,
    );
    (fun)(arg1)
}
...
pub unsafe fn sqlite3_str_appendall(
    ...
    assert!(! ptr.is_null(), "SQLite API not initialized or SQLite feature omitted");
    let fun: extern "C" fn(arg1: *mut sqlite3_str, zIn: *const ::std::os::raw::c_char) = ::std::mem::transmute(
        ptr,
    );
    (fun)(arg1, zIn)
}
...
pub unsafe fn sqlite3_database_file_object(
    ...
    let ptr = __SQLITE3_DATABASE_FILE_OBJECT
        .load(::std::sync::atomic::Ordering::Acquire);
    assert!(! ptr.is_null(), "SQLite API not initialized or SQLite feature omitted");
    let fun: extern "C" fn(arg1: *const ::std::os::raw::c_char) -> *mut sqlite3_file = ::std::mem::transmute(
        ptr,
    );
    (fun)(arg1)
}
...
pub unsafe fn sqlite3_vtab_distinct(
    ...
    assert!(! ptr.is_null(), "SQLite API not initialized or SQLite feature omitted");
    let fun: extern "C" fn(arg1: *mut sqlite3_index_info) -> ::std::os::raw::c_int = ::std::mem::transmute(
        ptr,
    );
    (fun)(arg1)
}
